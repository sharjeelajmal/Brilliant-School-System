...
import { LogOut, ClipboardList, FileBarChart2, MessageSquare } from 'lucide-react'; // MessageSquare Added
import { useRouter } from 'next/navigation';
import Link from 'next/link';

interface HeaderProps {
  title: string;
  activePage: 'attendance' | 'test-report' | 'complaints'; // 'complaints' added to type
}
