...
export const TestReportContent = () => {
  ...
  return (
    <div className="w-full">
      ...
      {/* HEADER */}
      <div className="mb-6">
        <h1 className="text-3xl font-black text-[#191919] uppercase tracking-tighter mb-2">Class Test Report</h1>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white p-6 md:p-8 rounded-[24px] shadow-xl border border-gray-100 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-start">
          <CustomDropdown label="Test Type" name="testType" value={filters.testType} onChange={handleFilterChange} options={["Surprise", "Weekly", "Monthly", "Round 1", "Round 2", "Round 3"]} />
