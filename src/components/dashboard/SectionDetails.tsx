        ...
        <div className="space-y-8 font-['Montserrat'] animate-in fade-in slide-in-from-right-10 duration-500">
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-4">
                    <ActionButton label="Add Student" icon={Plus} onClick={() => router.push(`/dashboard?tab=forms&class=${encodeURIComponent(className)}&section=${encodeURIComponent(sectionOnly)}`)} />
                    <ActionButton label="Mark Attendance" icon={CheckSquare} onClick={() => router.push(`/dashboard?tab=attendance&class=${encodeURIComponent(className)}&section=${encodeURIComponent(sectionOnly)}`)} />
